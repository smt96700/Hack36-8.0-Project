...
const JoinCommunity = () => {
  ...
  return (
    <div className="max-w-3xl mx-auto mt-10 bg-white/40 backdrop-blur-md p-6 rounded-xl shadow-xl">
      <h1 className="text-2xl font-bold mb-4 text-center">🌿 Join a Community Near You</h1>
      ...
      {accessLocation && (
        <div className="mb-8">
          <label className="block text-sm font-medium text-gray-700 mb-2">
            Specify Search Distance (in meters)
          </label>
